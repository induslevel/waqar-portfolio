            ...
            <div key={index} className="relative pl-8 border-l border-neutral-200 dark:border-neutral-800 pb-12 last:pb-0">
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                <div>
                  ...
                  <a href={exp.link} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 font-medium hover:underline">
                    {exp.company}
                  </a>
                </div>
                <p className="text-neutral-500 dark:text-neutral-500 text-sm mt-2 md:mt-0 font-mono">{exp.period}</p>
              </div>
              <ul className="space-y-3">
                {exp.description.map((desc, i) => (
                  <li key={i} className="text-neutral-700 dark:text-neutral-400 text-sm leading-relaxed flex items-start gap-2">
